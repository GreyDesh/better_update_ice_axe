...
import net.greydesh.gdbuax.init.GdbuaxModTabs;
import net.greydesh.gdbuax.init.GdbuaxModSounds;
import net.greydesh.gdbuax.init.GdbuaxModItems;
import net.greydesh.gdbuax.init.GdbuaxModBlocks;
import net.greydesh.gdbuax.init.GdbuaxModBlockEntities;
...
@Mod("gdbuax")
public class GdbuaxMod {
	public static final Logger LOGGER = LogManager.getLogger(GdbuaxMod.class);
	public static final String MODID = "gdbuax";
	...
	public GdbuaxMod() {
		...
		GdbuaxModSounds.REGISTRY.register(bus);
		GdbuaxModBlocks.REGISTRY.register(bus);
		GdbuaxModBlockEntities.REGISTRY.register(bus);
		GdbuaxModItems.REGISTRY.register(bus);

		GdbuaxModTabs.REGISTRY.register(bus);
						...
						for (Field field : fields) {
							if (EditBox.class.isAssignableFrom(field.getType())) {
								try {
									...
									GdbuaxMod.LOGGER.error(exceptionAsString);
								}
							}
						}
					}
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			GdbuaxMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
